...
VALUES (N'20250319111118_SHOPIFYWebsite', N'9.0.3');
...
ALTER TABLE [Products] ALTER COLUMN [SubCategoriesId] int NULL;

ALTER TABLE [Products] ADD CONSTRAINT [FK_Products_SubCategories_SubCategoriesId] FOREIGN KEY ([SubCategoriesId]) REFERENCES [SubCategories] ([SubCategoriesId]);

INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250319120504_SHOPIFYWebsitesss', N'9.0.3');
