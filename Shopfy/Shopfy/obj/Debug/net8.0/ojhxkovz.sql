...
CREATE TABLE [OrderItems] (
    ...
    CONSTRAINT [FK_OrderItems_Order_OrdersId] FOREIGN KEY ([OrdersId]) REFERENCES [Order] ([Id]) ON DELETE CASCADE,
...
VALUES (N'20250319081134_ShopifyWebsite', N'9.0.3');

ALTER TABLE [OrderItems] DROP CONSTRAINT [FK_OrderItems_Order_OrdersId];

ALTER TABLE [Payment] DROP CONSTRAINT [FK_Payment_Order_OrderId];
...
WHERE ([d].[parent_object_id] = OBJECT_ID(N'[Payment]') AND [c].[name] = N'OrderId');
IF @var IS NOT NULL EXEC(N'ALTER TABLE [Payment] DROP CONSTRAINT [' + @var + '];');
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20250319081436_ShopifyWebsites', N'9.0.3');
